...
import com.youfan.input.XiaoChenXuProductCartLog;
import com.youfan.input.XiaoChenXuProductHuoDong;
...
public class XiaoChenXuCartGenerateData {
    ...
    private static XiaoChenXuProductCartLog genernateData(){
        ...
        xiaoChenXuProductCartLog.setLogType(LogType.XIAOCHENXUCART);
