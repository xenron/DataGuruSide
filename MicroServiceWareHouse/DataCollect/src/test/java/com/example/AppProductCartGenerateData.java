...
import com.example.input.AppProductCartLog;
...
public class AppProductCartGenerateData {
    ...
    private static AppProductCartLog genernateData(){
        ...
        appProductCartLog.setLogType(LogType.APPCART);
    ...
    public static void main(String[] args) {
        for(int i =0;i<50;i++){
            ...
            postHttpMethod("http://127.0.0.1:8081/collectAppData",JSONObject.toJSONString(JSONObject.toJSON(appProductCartLog)));
        }
